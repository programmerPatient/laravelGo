/*
 * @Description:自定义gorm的日志
 * @Author: mali
 * @Date: 2022-09-08 17:15:11
 * @LastEditTime: 2022-09-09 13:47:56
 * @LastEditors: VSCode
 * @Reference:
 */
package logger
 ...
 * @Author: mali
 * @Func:
 * @Description: 实例化一个 GormLogger 对象
 * @Param:
 * @Return:
 * @Example:
 */
func NewGormLogger(times time.Duration) GormLogger {
	return GormLogger{
		ZapLogger:     Logger,
		SlowThreshold: times * time.Millisecond, // 慢查询阈值，单位为千分之一秒,
	}
}
